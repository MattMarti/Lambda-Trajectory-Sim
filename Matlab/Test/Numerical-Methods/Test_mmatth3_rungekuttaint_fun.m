%% Test_mmatth3_rungekuttaint_fun.m
% 
...
% Compute test values
[yout, tout, ydotout] = mmatth3_rungekuttaint_fun(ydot, y0, tlims, h);
...
% Compute test values
[yout, tout] = mmatth3_rungekuttaint_fun(ydot, y0, tlims, h, 3);
...
% Compute test values
[yout, tout] = mmatth3_rungekuttaint_fun(ydot, y0, tlims, h, 2);
...
% Compute test values
[yout, tout] = mmatth3_rungekuttaint_fun(ydot, y0, tlims, h, 1);
...
% Compute test values
[yout, tout] = mmatth3_rungekuttaint_fun(ydot, y0, tlims, h, ...
    4, cvec, amat, bvec);
...
% Compute test values
[yout6, tout] = mmatth3_rungekuttaint_fun(ydot, y0, tlims, h, 6);
...
fprintf('PASSED: Test_mmatth3_rungekuttaint_fun\n');